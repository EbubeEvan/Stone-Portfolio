...
Files: scene.gltf [10.23KB] > C:\Users\user\Desktop\Projects\Stone's Portfolio\public\planet\scene-transformed.glb [329.67KB] (-3123%)
...
export function EarthModel() {
  ...
  return (
    <group ref={group} dispose={null} scale={2.5} position-y={0} rotation-y={0}>
